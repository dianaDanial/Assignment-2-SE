  ...
  <div class="w3-container w3-light-grey w3-center" style="padding:80px 16px; "
    <div class="card"  "center" style="width:auto;" >
      ...
      <div class="form-group">
        ...
        <br>
        <h2 style="color:#000080 ;text-decoration: underline;">Record University</h2>
        <form action="registerUni.php" method="post">
          <div class="container mt-3">
          <div class="input-group mb-3">
            <div class="input-group-prepend">
              <span class="input-group-text">University</span>
            </div>
            <input type="text" class="form-control" placeholder="Enter University Name" id="universityName" name="universityName" value="<?php echo $universityName;?>">
          </div>
        </div>
        <button type="submit" class="btn btn-info btn-md btn-block" name="register_Uni">Register University</button>
      </form>
    </div>
  </div>
</body>
