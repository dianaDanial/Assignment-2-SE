...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css">
  ...
  <nav class="navbar navbar-expand-md bg-light navbar-light">
    ...
    <div class="w3-bar w3-red w3-card w3-left-align w3-large">
      ...
      <a href="signUpSASadmin.php" class="w3-bar-item w3-button w3-padding-large w3-white">Sign Up</a>
  ...
  <div class="w3-container w3-light-grey w3-center" style="padding:80px 16px; "
    <div class="card"  "center" style="width:auto;" >
      <br>
      <br>
        <img class="card-img-top mx-auto d-block" src="usericon.png" alt=" Sign up icon of user" style="width:20%;" >
        <h1 class="text-center">Sign Up As SAS Admin</h1>
        <form method="post" action="signUpSASadmin.php">
          ...
          <div class="container mt-3">
            ...
            <button type="submit" class="btn btn-danger" name="reg_SASadmin" onclick="return validateSignupForm();">Sign Up</button>
          </form>
      </div>
    </div>
  </div>
